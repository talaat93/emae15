  ...
  <div class="wrap">
    ...
    <div class="process-grid">
      ...
      <div class="process-step">
        <div class="process-num"><?= str_pad((string)$_pn,2,'0',STR_PAD_LEFT) ?></div>
...
<section class="sec sec-card"><div class="wrap">
  ...
  <div class="steps-grid" style="margin-top:1.75rem;">
    <div class="step-card"><div class="step-num">01</div><div><div class="step-h"><?= e(setting('process_1_title','Contact immédiat')) ?></div><p class="step-p"><?= e(setting('process_1_text','Appelez ou envoyez votre demande. Nous répondons immédiatement.')) ?></p></div></div>
    <div class="step-card"><div class="step-num">02</div><div><div class="step-h"><?= e(setting('process_2_title','Déplacement rapide')) ?></div><p class="step-p"><?= e(setting('process_2_text','Technicien qualifié dépêché sur place. Délai et tarif confirmés avant déplacement.')) ?></p></div></div>
    <div class="step-card"><div class="step-num">03</div><div><div class="step-h"><?= e(setting('process_3_title','Intervention & rapport')) ?></div><p class="step-p"><?= e(setting('process_3_text','Diagnostic, réparation ou installation. Compte rendu et facture détaillés.')) ?></p></div></div>
  </div>
</div></section>
